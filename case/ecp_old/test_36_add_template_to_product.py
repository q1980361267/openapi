...
from assist import getOpenApiPramsTemplate, getSignature, getTemplateInfo, getGatewayProductInfo
...
class Test_CreateGatewayDeviceAssociate(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.url = getOpenApiPramsTemplate.get_url() + '/objtemplate/property/withtemplate'
