...
from assist import getOpenApiPramsTemplate, getSignature, getDeviceInfo
...
class Test_CreateGatewayDeviceAssociate(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.id_dev_third = getDeviceInfo.getGatewayDevicesIdThird()
    ...
    def test_00(self):  # 执行逻辑::设置入参，参数正确填写
        ...
        body = {
            'deviceIds': [self.id_dev_first, self.id_dev_second, self.id_dev_third]
        }
