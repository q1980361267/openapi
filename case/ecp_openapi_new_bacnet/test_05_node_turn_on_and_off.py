...
class Get_modifyNodeDev(unittest.TestCase):
    """查询边缘节点列表属性接口"""
    ...
    def setUp(self):
        # self.gid = gid
        self.url = url + '/edgenode/pro/adminstate/multi'
    ...
    def test_00(self):  # 执行逻辑::设置入参，参数正确填写
        ...
        r = requests.put(url=self.url, params=params, data=json.dumps(body), headers=self.headers, verify=False)
