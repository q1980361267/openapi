...
from assist import getOpenApiPramsTemplate, getSignature, getGatewayProductInfo, getFunctionInfo


class Test_DeleteFunction(unittest.TestCase):
    """删除边缘终端产品功能(mqtt)接口"""
    ...
    def test_00(self):  # 执行逻辑::设置入参，参数正确填写
        ...
        # print(r.text.lower())
        logging.info(f"case:删除边缘终端产品功能(mqtt)-成功\n请求地址：{r.url}\t请求方式:{r.request.method}\n请求头：{r.request.headers}\n请求正文：{parse.unquote(r.request.body)}\n响应头：{r.headers}\n响应正文：{r.text}\n")
