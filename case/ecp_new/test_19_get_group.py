...
from assist import getOpenApiPramsTemplate, getSignature, getGatewayProductInfo,getGroupInfo
...
class Test_GetGroup(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.url = getOpenApiPramsTemplate.get_url() + '/label/id'+'/'+str(self.id_group)
